...
public class UnsplashPagingSource extends PagingSource<Integer,UnsplashPhoto> {
    ...
    @Nullable
    @Override
    public LoadResult<Integer,UnsplashPhoto> load(@NotNull LoadParams<Integer> loadParams, @NotNull Continuation<? super LoadResult<Integer, UnsplashPhoto>> continuation) {
